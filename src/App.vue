...
//codigo hecho con fecth y promises
onMounted(() => {
...
const cotizarCripto = () => {
  //validar que cotizar este completo, si el objeto cotizar incluye un espacio vacio entonces: 
...
//codigo hecho con fetch y async await
